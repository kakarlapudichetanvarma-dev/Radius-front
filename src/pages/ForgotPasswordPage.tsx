      ...
      >
        ...
        >
          ...
          <p className="text-zinc-400 text-base leading-relaxed max-w-sm">
            Enter your email address and we'll send you a secure OTP to reset your password in seconds.
          </p>
        </motion.div>
          ...
          <div className="flex-1 rounded-2xl border border-yellow-400/12 bg-[#090909] overflow-hidden shadow-[0_0_60px_rgba(250,204,21,0.05)] flex flex-col">
            <div className="px-5 py-4 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm">Radius Support</p>
              ...
              {MESSAGES.map((m, i) => (
                ...
                >
                  <div className={`max-w-[72%] px-3.5 py-2.5 rounded-2xl text-sm leading-snug ${
                    m.own ? 'bg-yellow-400 text-black font-medium rounded-br-sm' : 'bg-white/[0.06] text-zinc-200 rounded-bl-sm'
                  }`}>
                    {m.msg}
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-10 relative z-10">
        ...
        >
          ...
          <div>
            ...
            <h1 className="text-3xl font-extrabold tracking-tight mb-1.5">Forgot password?</h1>
          ...
          <p className="text-center text-zinc-500 text-sm">
            ...
            <Link to="/login" className="text-yellow-400 font-semibold hover:text-yellow-300 transition-colors duration-200">Sign in →</Link>
          </p>
        </motion.div>
      </div>
