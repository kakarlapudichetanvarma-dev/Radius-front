        ...
        {fullscreenAvatar && (
          ...
          >
            {avatarUrl ? (
              ...
              <div className="w-80 h-80 rounded-full bg-violet-600 flex items-center justify-center text-white text-8xl font-bold shadow-2xl">
        ...
        <div className="flex flex-col items-center py-8 px-4 border-b border-gray-100">
          ...
          >
            {avatarUrl ? (
              ...
              <div className="w-24 h-24 rounded-full bg-violet-600 flex items-center justify-center text-white text-3xl font-bold ring-2 ring-violet-200 group-hover:ring-violet-400 transition">
                {username?.charAt(0).toUpperCase() || '?'}
              </div>
            )}
          ...
          <p className="text-gray-900 font-semibold text-lg">{username || 'Unknown'}</p>

          {(friend as any)?.phoneNumber ? (
            <p className="text-gray-400 text-sm mt-1">{(friend as any).phoneNumber}</p>
          ) : (
            <p className="text-gray-300 text-sm mt-1 italic">No phone number</p>
          )}
        </div>
