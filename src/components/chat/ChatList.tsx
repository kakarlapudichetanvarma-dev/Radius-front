...
export default function ChatList() {
  ...
  const getAvatarUrl = (
    ...
    // ✅ Live update first
    if (liveUpdates[username]) {
      return liveUpdates[username];
    }
    ...
    return (
      <div className="relative flex-shrink-0">
        {avatarUrl ? (
          ...
          <div
            className={`w-${size} h-${size} rounded-full bg-zinc-700 flex items-center justify-center text-white font-medium`}
          >
            {isGroup
              ? '👥'
              : getChatInitial(chat)}
  ...
  return (
    <div className="flex-1 overflow-y-auto flex flex-col">
      ...
      <div className="flex-1">
        ...
        {chats.length > 0 && (
          <div>
            <p className="text-zinc-500 text-xs px-4 py-2 uppercase tracking-wider">
              Chats
            </p>
