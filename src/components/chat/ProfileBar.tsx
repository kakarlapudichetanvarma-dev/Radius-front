...
const ProfileBar = memo(function ProfileBar() {
  ...
  return (
    <>
      ...
      <div className="h-14 border-b border-gray-200 bg-white flex items-center justify-around px-3 w-full">

        <button
          className="w-10 h-10 rounded-full hover:bg-gray-100 flex items-center justify-center text-gray-500 hover:text-violet-600 transition-colors"
          title="Calls"
        >
          <Phone size={20} />
        </button>
